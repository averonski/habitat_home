...
<!-- <style>
	...
	*/
	...
	<form  action="index.php" method="get">
	    ...
	    <tr><td><label><span class="mandatory">*</span>Username</label></td><td> <input type="text" name="userName" id="userName" value="<?php echo $email ?>" disabled="disabled"></td><td> &nbsp<span style="color:lightgrey; font-size: 10pt;">(Your Email id will be used as your Username) <a href="index.php?act=getInfo">Change Email/Username</a></span> </td></tr>
