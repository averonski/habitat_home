...
///////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public function getAccountType($personId){
			...
			if(mysql_fetch_row($results)){
				...
				$rows= mysql_fetch_array($results2);
				var_dump($rows[0]);
				if($rows[0]=='1'){
					return '2';
				}
...
//////////////////////////////////////|-_-_-_-|\///////////////////////////////////////////////////////////////	   
	...
	public function updateInfo($pid,$person,$contact,$address) {
		...
		$sql = "update Person set title='" . $person->getTitle() ."', first_name='" . $person->getFirst_name() . "' , last_name='" . $person->getLast_name() . "' , dob='" . $person->getDob() . "' , employer='" . $person->getEmployer() . "' , jobTitle='" . $person->getJobtitle() . "' where person_id=" . $pid . ";" ;
