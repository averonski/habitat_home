<?php
    ...
    class DBIO {
        ...
        /*function open() {
                ...
                $dbname="homes_db";
                 ...
                 global $con;
                 $con = mysqli_connect($hostname,$username, $password) or die ("no worky");
        ...
        */
        ...
        public function getLogin($user,$pw){
            ...
            $results=mysqli_query($sql2,$con);
            $final=mysqli_fetch_row($results);
            $status=$final[0];
            $this->close();
        ...
        public function getAccountType($person_id){
            ...
            $this->open();
            $results1 = mysqli_query($sql1,$con);
                $row1 = mysqli_fetch_array($results1);
            $results2= mysqli_query($sql2,$con);
	...
	public function createAccount($account, $array) {
		...
		$id = ($results) ? mysqli_insert_id() : $results;
		$this->close();
		return $id;
	}// end function
	...
	public function readDonation($id) {
		...
		if ($results) {
			...
			while($result = mysqli_fetch_array($results)) {
				...
				$donation->setDonor_id($result[6]); //altered this will need to be corrected
